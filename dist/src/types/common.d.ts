...
export type IconType = ReactNode | any | ForwardRefExoticComponent<Omit<SVGProps<SVGSVGElement>, 'ref'> & {
    title?: string | undefined;
    titleId?: string | undefined;
} & RefAttributes<SVGSVGElement>>;
export type VariantType = 'primary' | 'success' | 'warning' | 'danger' | 'info' | 'ghost' | 'subdued' | 'dark' | 'default';
