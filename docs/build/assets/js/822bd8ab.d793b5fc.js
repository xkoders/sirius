...
;(self.webpackChunk_adersolutions_sirius_docs =
  ...
  [2748],
  {
    3932: (s, t, e) => {
      ...
      const n = JSON.parse(
        '{"id":"tutorial-basics/congratulations","title":"Congratulations!","description":"You have just learned the basics of Docusaurus and made some changes to the initial template.","source":"@site/docs/tutorial-basics/congratulations.md","sourceDirName":"tutorial-basics","slug":"/tutorial-basics/congratulations","permalink":"/docs/tutorial-basics/congratulations","draft":false,"unlisted":false,"editUrl":"https://github.com/xkoders/sirius/tree/main/docs/docs/tutorial-basics/congratulations.md","tags":[],"version":"current","sidebarPosition":6,"frontMatter":{"sidebar_position":6}}',
      )
      var o = e(6106),
        i = e(9185)
      const r = { sidebar_position: 6 },
        a = 'Congratulations!',
        c = {},
        u = [{ value: 'What&#39;s next?', id: 'whats-next', level: 2 }]
      function d(s) {
        const t = {
          a: 'a',
          code: 'code',
        ...
        return (0, o.jsxs)(o.Fragment, {
          children: [
            (0, o.jsx)(t.header, {
              children: (0, o.jsx)(t.h1, { id: 'congratulations', children: 'Congratulations!' }),
            }),
            '\n',
            (0, o.jsxs)(t.p, {
              children: [
                'You have just learned the ',
                (0, o.jsx)(t.strong, { children: 'basics of Docusaurus' }),
                ' and made some changes to the ',
                (0, o.jsx)(t.strong, { children: 'initial template' }),
                '.',
              ],
            }),
            '\n',
            (0, o.jsxs)(t.p, {
              children: [
                'Docusaurus has ',
                (0, o.jsx)(t.strong, { children: 'much more to offer' }),
                '!',
              ],
            }),
            '\n',
            (0, o.jsxs)(t.p, {
              children: [
                'Have ',
                (0, o.jsx)(t.strong, { children: '5 more minutes' }),
                '? Take a look at ',
                (0, o.jsx)(t.strong, {
            ...
            (0, o.jsxs)(t.p, {
              children: [
                'Anything ',
                (0, o.jsx)(t.strong, { children: 'unclear' }),
                ' or ',
                (0, o.jsx)(t.strong, { children: 'buggy' }),
                ' in this tutorial? ',
                (0, o.jsx)(t.a, {
                ...
                (0, o.jsxs)(t.li, {
                  children: [
                    ...
                    (0, o.jsx)(t.a, {
                      ...
                      children: (0, o.jsx)(t.code, { children: 'docusaurus.config.js' }),
                    }),
                  ],
                }),
                '\n',
                (0, o.jsxs)(t.li, {
                  children: [
                    ...
                    (0, o.jsx)(t.a, {
                      ...
                      children: (0, o.jsx)(t.code, { children: 'themeConfig' }),
                    }),
                  ],
                }),
                '\n',
      ...
      function l(s = {}) {
        const { wrapper: t } = { ...(0, i.R)(), ...s.components }
        return t ? (0, o.jsx)(t, { ...s, children: (0, o.jsx)(d, { ...s }) }) : d(s)
      }
    },
    9185: (s, t, e) => {
      e.d(t, { R: () => r, x: () => a })
      ...
      function r(s) {
        ...
        return n.useMemo(
          function () {
            return 'function' == typeof s ? s(t) : { ...t, ...s }
          },
          [t, s],
        )
      }
      function a(s) {
        let t
        return (
          (t = s.disableParentContext
            ? 'function' == typeof s.components
              ? s.components(o)
              : s.components || o
            : r(s.components)),
          n.createElement(i.Provider, { value: t }, s.children)
        )
      }
    },
  },
