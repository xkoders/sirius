...
;(self.webpackChunk_adersolutions_sirius_docs =
  ...
  [8863],
  {
    1917: (e, s, t) => {
      ...
      const r = JSON.parse(
        '{"id":"tutorial-basics/deploy-your-site","title":"Deploy your site","description":"Docusaurus is a static-site-generator (also called Jamstack).","source":"@site/docs/tutorial-basics/deploy-your-site.md","sourceDirName":"tutorial-basics","slug":"/tutorial-basics/deploy-your-site","permalink":"/docs/tutorial-basics/deploy-your-site","draft":false,"unlisted":false,"editUrl":"https://github.com/xkoders/sirius/tree/main/docs/docs/tutorial-basics/deploy-your-site.md","tags":[],"version":"current","sidebarPosition":5,"frontMatter":{"sidebar_position":5}}',
      )
      var o = t(6106),
        i = t(9185)
      ...
      function a(e) {
        ...
        return (0, o.jsxs)(o.Fragment, {
          children: [
            (0, o.jsx)(s.header, {
              children: (0, o.jsx)(s.h1, { id: 'deploy-your-site', children: 'Deploy your site' }),
            }),
            '\n',
            (0, o.jsxs)(s.p, {
              children: [
                'Docusaurus is a ',
                (0, o.jsx)(s.strong, { children: 'static-site-generator' }),
                ' (also called ',
                (0, o.jsx)(s.strong, {
            ...
            (0, o.jsxs)(s.p, {
              children: [
                ...
                (0, o.jsx)(s.strong, { children: 'static HTML, JavaScript and CSS files' }),
                '.',
              ],
            }),
            '\n',
            ...
            (0, o.jsxs)(s.p, {
              children: [
                'Build your site ',
                (0, o.jsx)(s.strong, { children: 'for production' }),
                ':',
              ],
            }),
            '\n',
            ...
            (0, o.jsxs)(s.p, {
              children: [
                ...
                (0, o.jsx)(s.code, { children: 'build' }),
                ' folder ',
                (0, o.jsx)(s.strong, { children: 'almost anywhere' }),
                ' easily, ',
                (0, o.jsx)(s.strong, { children: 'for free' }),
