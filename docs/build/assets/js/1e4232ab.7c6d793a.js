...
;(self.webpackChunk_adersolutions_sirius_docs =
  ...
  [1953],
  {
    3325: (e, s, t) => {
      ...
      const n = JSON.parse(
        '{"id":"tutorial-basics/create-a-document","title":"Create a Document","description":"Documents are groups of pages connected through:","source":"@site/docs/tutorial-basics/create-a-document.md","sourceDirName":"tutorial-basics","slug":"/tutorial-basics/create-a-document","permalink":"/docs/tutorial-basics/create-a-document","draft":false,"unlisted":false,"editUrl":"https://github.com/xkoders/sirius/tree/main/docs/docs/tutorial-basics/create-a-document.md","tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"sidebar_position":2}}',
      )
      var r = t(6106),
        o = t(9185)
      const i = { sidebar_position: 2 },
        ...
        c = {},
        l = [
          { value: 'Create your first Doc', id: 'create-your-first-doc', level: 2 },
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
            ...
            (0, r.jsxs)(s.p, {
              children: [
                'Documents are ',
                (0, r.jsx)(s.strong, { children: 'groups of pages' }),
                ' connected through:',
              ],
            }),
            '\n',
            (0, r.jsxs)(s.ul, {
              children: [
                '\n',
                (0, r.jsxs)(s.li, {
                  children: ['a ', (0, r.jsx)(s.strong, { children: 'sidebar' })],
                }),
                '\n',
                (0, r.jsx)(s.li, {
                  children: (0, r.jsx)(s.strong, { children: 'previous/next navigation' }),
                }),
                '\n',
                (0, r.jsx)(s.li, { children: (0, r.jsx)(s.strong, { children: 'versioning' }) }),
                '\n',
              ],
            }),
            '\n',
            (0, r.jsx)(s.h2, { id: 'create-your-first-doc', children: 'Create your first Doc' }),
            '\n',
            (0, r.jsxs)(s.p, {
              children: [
                'Create a Markdown file at ',
                (0, r.jsx)(s.code, { children: 'docs/hello.md' }),
                ':',
              ],
            }),
            '\n',
            ...
            '\n',
            (0, r.jsx)(s.h2, { id: 'configure-the-sidebar', children: 'Configure the Sidebar' }),
            '\n',
            (0, r.jsxs)(s.p, {
              children: [
                'Docusaurus automatically ',
                (0, r.jsx)(s.strong, { children: 'creates a sidebar' }),
                ' from the ',
                (0, r.jsx)(s.code, { children: 'docs' }),
                ' folder.',
              ],
            }),
            '\n',
            ...
            (0, r.jsxs)(s.p, {
              children: [
                ...
                (0, r.jsx)(s.code, { children: 'sidebars.js' }),
                ':',
              ],
            }),
            '\n',
      ...
      function u(e = {}) {
        ...
        return s ? (0, r.jsx)(s, { ...e, children: (0, r.jsx)(d, { ...e }) }) : d(e)
      }
    },
    9185: (e, s, t) => {
      t.d(s, { R: () => i, x: () => a })
