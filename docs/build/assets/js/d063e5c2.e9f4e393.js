...
;(self.webpackChunk_adersolutions_sirius_docs =
  ...
  [5723],
  {
    7031: (n, e, s) => {
      ...
      const i = JSON.parse(
        '{"id":"components/feedbacks/spinner","title":"Spinner","description":"A loading spinner component for indicating asynchronous operations and loading states.","source":"@site/docs/components/feedbacks/spinner.md","sourceDirName":"components/feedbacks","slug":"/components/feedbacks/spinner","permalink":"/docs/components/feedbacks/spinner","draft":false,"unlisted":false,"editUrl":"https://github.com/xkoders/sirius/tree/main/docs/docs/components/feedbacks/spinner.md","tags":[],"version":"current","frontMatter":{"id":"spinner","title":"Spinner","sidebar_label":"Spinner"}}',
      )
      var t = s(6106),
        r = s(9185)
      const a = { id: 'spinner', title: 'Spinner', sidebar_label: 'Spinner' },
        l = 'Spinner',
        d = {},
        c = [
          ...
          { value: 'Default Spinner', id: 'default-spinner', level: 3 },
          { value: 'Small Spinner', id: 'small-spinner', level: 3 },
          { value: 'Medium Spinner', id: 'medium-spinner', level: 3 },
          { value: 'Large Spinner', id: 'large-spinner', level: 3 },
          { value: 'Custom Size', id: 'custom-size', level: 3 },
          { value: '\ud83d\udd27 Props', id: '-props', level: 2 },
          { value: '\ud83c\udfaf Examples', id: '-examples', level: 2 },
          { value: 'Button with Loading State', id: 'button-with-loading-state', level: 3 },
          { value: 'Form Loading State', id: 'form-loading-state', level: 3 },
          { value: 'Page Loading State', id: 'page-loading-state', level: 3 },
          { value: 'Inline Loading', id: 'inline-loading', level: 3 },
          { value: '\ud83c\udfa8 CSS Classes', id: '-css-classes', level: 2 },
          { value: 'Size Classes', id: 'size-classes', level: 3 },
      ...
      function o(n) {
        ...
        return (0, t.jsxs)(t.Fragment, {
          children: [
            (0, t.jsx)(e.header, {
              children: (0, t.jsx)(e.h1, { id: 'spinner', children: 'Spinner' }),
            }),
            '\n',
            (0, t.jsx)(e.p, {
              children:
            ...
            (0, t.jsx)(e.pre, {
              children: (0, t.jsx)(e.code, {
                className: 'language-tsx',
                children: '<Spinner size="none" className="w-8 h-8" />\n',
              }),
            }),
            '\n',
            ...
            (0, t.jsxs)(e.table, {
              children: [
                (0, t.jsx)(e.thead, {
                  children: (0, t.jsxs)(e.tr, {
                    children: [
                      (0, t.jsx)(e.th, { children: 'Prop' }),
                      (0, t.jsx)(e.th, { children: 'Type' }),
                      (0, t.jsx)(e.th, { children: 'Default' }),
                      (0, t.jsx)(e.th, { children: 'Description' }),
                    ],
                  }),
                }),
                (0, t.jsxs)(e.tbody, {
                  children: [
                    (0, t.jsxs)(e.tr, {
                      children: [
                        (0, t.jsx)(e.td, { children: (0, t.jsx)(e.code, { children: 'size' }) }),
                        (0, t.jsx)(e.td, {
                          children: (0, t.jsx)(e.code, {
                            children: "'small' | 'medium' | 'large' | 'none'",
                          }),
                        }),
                        (0, t.jsx)(e.td, {
                          children: (0, t.jsx)(e.code, { children: "'medium'" }),
                        }),
                        (0, t.jsx)(e.td, { children: 'Size of the spinner' }),
                      ],
                    }),
                    (0, t.jsxs)(e.tr, {
                      children: [
                        (0, t.jsx)(e.td, {
                          children: (0, t.jsx)(e.code, { children: 'className' }),
                        }),
                        (0, t.jsx)(e.td, { children: (0, t.jsx)(e.code, { children: 'string' }) }),
                        (0, t.jsx)(e.td, {
                          children: (0, t.jsx)(e.code, { children: 'undefined' }),
                        }),
                        (0, t.jsx)(e.td, { children: 'Additional CSS classes' }),
                      ],
                    }),
                  ],
                }),
            ...
            (0, t.jsx)(e.h3, {
              ...
              children: 'Button with Loading State',
            }),
            '\n',
            (0, t.jsx)(e.pre, {
              children: (0, t.jsx)(e.code, {
            ...
            (0, t.jsxs)(e.ul, {
              children: [
                ...
                (0, t.jsxs)(e.li, {
                  children: [
                    (0, t.jsx)(e.code, { children: '.sirius-spinner' }),
                    ' - Base spinner class',
                  ],
                }),
                '\n',
                (0, t.jsxs)(e.li, {
                  children: [
                    (0, t.jsx)(e.code, { children: '.sirius-spinner--{size}' }),
            ...
            '\n',
            (0, t.jsx)(e.p, {
              children: 'The Spinner component includes several accessibility features:',
            }),
            '\n',
            (0, t.jsxs)(e.ul, {
              children: [
                ...
                (0, t.jsxs)(e.li, {
                  children: [
                    (0, t.jsx)(e.strong, { children: 'ARIA Support' }),
                    ': Uses ',
                    (0, t.jsx)(e.code, { children: 'aria-hidden="true"' }),
                ...
                (0, t.jsxs)(e.li, {
                  children: [
                    (0, t.jsx)(e.strong, { children: 'Semantic Meaning' }),
                ...
                (0, t.jsxs)(e.li, {
                  children: [
                    (0, t.jsx)(e.strong, { children: 'Focus Management' }),
      ...
      function h(n = {}) {
        ...
        return e ? (0, t.jsx)(e, { ...n, children: (0, t.jsx)(o, { ...n }) }) : o(n)
      }
    },
    9185: (n, e, s) => {
      s.d(e, { R: () => a, x: () => l })
