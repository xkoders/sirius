  ...
  [8609],
  {
    ...
    4189: (t, s, e) => {
      ...
      const i = {
        ...
        u = []
      function c(t) {
        const s = { p: 'p', ...(0, r.R)(), ...t.components }
        return (0, n.jsx)(s.p, { children: 'Lorem ipsum dolor sit amet...' })
      }
      function g(t = {}) {
        const { wrapper: s } = { ...(0, r.R)(), ...t.components }
        return s ? (0, n.jsx)(s, { ...t, children: (0, n.jsx)(c, { ...t }) }) : c(t)
      }
    },
    9185: (t, s, e) => {
      e.d(s, { R: () => i, x: () => a })
