  ...
  [1724],
  {
    1125: (e, s, n) => {
          ...
          children: [
            ...
            (0, r.jsxs)(s.p, {
              children: [
                ...
                (0, r.jsx)(s.code, { children: 'versioned_docs/version-1.0' }),
                ' and ',
                (0, r.jsx)(s.code, { children: 'versions.json' }),
                ' is created.',
              ],
            }),
            '\n',
            ...
            (0, r.jsxs)(s.ul, {
              children: [
                ...
                (0, r.jsxs)(s.li, {
                  children: [
                    (0, r.jsx)(s.code, { children: '1.0' }),
                    ' at ',
                    (0, r.jsx)(s.code, { children: 'http://localhost:3000/docs/' }),
                ...
                (0, r.jsxs)(s.li, {
                  children: [
                    (0, r.jsx)(s.code, { children: 'current' }),
                    ' at ',
                    (0, r.jsx)(s.code, { children: 'http://localhost:3000/docs/next/' }),
                    ' for the ',
                    (0, r.jsx)(s.strong, { children: 'upcoming, unreleased docs' }),
                  ],
                }),
                '\n',
              ],
            ...
            (0, r.jsxs)(s.p, {
              children: [
                'Modify the ',
                (0, r.jsx)(s.code, { children: 'docusaurus.config.js' }),
                ' file:',
              ],
            }),
            '\n',
            ...
            (0, r.jsxs)(s.ul, {
              children: [
                ...
                (0, r.jsxs)(s.li, {
                  children: [
                    (0, r.jsx)(s.code, { children: 'versioned_docs/version-1.0/hello.md' }),
                    ' updates ',
                    (0, r.jsx)(s.code, { children: 'http://localhost:3000/docs/hello' }),
                  ],
                }),
                '\n',
                (0, r.jsxs)(s.li, {
                  children: [
                    ...
                    ' updates ',
                    (0, r.jsx)(s.code, { children: 'http://localhost:3000/docs/next/hello' }),
                  ],
                }),
                '\n',
              ],
      ...
      function h(e = {}) {
        ...
        return s ? (0, r.jsx)(s, { ...e, children: (0, r.jsx)(l, { ...e }) }) : l(e)
      }
    },
    3617: (e, s, n) => {
      n.d(s, { A: () => o })
      const o = n.p + 'assets/images/docsVersionDropdown-35e13cbe46c9923327f30a76a90bff3b.png'
    },
    9185: (e, s, n) => {
      n.d(s, { R: () => d, x: () => t })
      var o = n(7378)
