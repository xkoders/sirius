          ...
          <div className="pt-6">
            <div className="flow-root bg-white rounded-lg px-6 pb-8">
              <div className="-mt-6">
                ...
                <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Fast & Lightweight</h3>
          ...
          <div className="pt-6">
            <div className="flow-root bg-white rounded-lg px-6 pb-8">
              <div className="-mt-6">
                ...
                <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Accessible</h3>
                <p className="mt-5 text-base text-gray-500">
          ...
          <div className="pt-6">
            <div className="flow-root bg-white rounded-lg px-6 pb-8">
              <div className="-mt-6">
                ...
                <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Customizable</h3>
                <p className="mt-5 text-base text-gray-500">
